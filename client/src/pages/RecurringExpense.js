...
export function RecurringExpense() {
  ...
  const getNextDueDate = (schedule, dueDate) => {
      ...
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('div', {
            ...
            children: _jsx('h2', {
              className:
                'md:text-6xl text-4xl font-bold text-center text-black ml-10 md:ml-[-10px] mr-40 mt-4 md:mt-7 md:mb-4 ',
              children: 'Recurring',
            }),
          }),
          _jsxs('div', {
            ...
            expenses.map((expense, index) =>
              _jsxs(
                'div',
                {
                  ...
                  children: [
                    _jsx('div', {
                      className: 'flex px-2 md:mt-2 mb-2 md:mb-3 pt-1',
                      children: _jsx('p', { children: expense.name }),
                    }),
                    _jsxs('div', {
                      ...
                      children: [
                        _jsxs('p', {
                          children: [
                            'Next Due: ',
                            getNextDueDate(expense.schedule, expense.dueDate),
                          ],
                        }),
