...
export function Home() {
  ...
  const [, setStoredExpenses] = useState([]);
  ...
  return _jsxs('div', {
    ...
    children: [
      _jsxs('div', {
        ...
        children: [
          ...
          _jsx('div', {
            ...
            children: _jsx('h2', {
              className:
                'md:text-6xl text-4xl font-bold text-center text-black ml-12 md:ml-[-10px] mr-40 mt-4 md:mt-7 md:mb-4 ',
              children: 'Expenses',
            }),
          }),
          _jsxs('div', {
      ...
      _jsx('p', {
        className: ' text-2xl text-black ml-2 md:text-3xl',
        children:
          expenses.length === 0 ? 'No Current Expenses' : 'Current Expenses',
      }),
      _jsxs('div', {
        className: 'space-y-3 mt-3 px-[5px]',
        children: [
          expenses.length === 0 &&
            _jsx(_Fragment, {
              children: _jsxs('div', {
                ...
                children: [
                  _jsx('div', {
                    className:
                      ' md:mb-2 md:h-20 h-16 mb-1 bg-[#EFEFEF] rounded-lg shadow-md shadow-[#00000099] border',
                  }),
                  _jsx('div', {
                    className:
                      ' md:mb-2 md:h-20 h-16 mb-1 bg-[#EFEFEF] rounded-lg shadow-md shadow-[#00000099]',
                  }),
                  _jsx('div', {
                    className:
                      ' md:mb-2 md:h-20 h-16 mb-1 bg-[#EFEFEF] rounded-lg shadow-md shadow-[#00000099]',
          ...
          expenses.length > 0 &&
            expenses.map((expense) =>
              _jsxs(
                ...
                {
                  className:
                    'mb-[-4px] md:mb-[-5px] md:text-xl h-16 md:h-20 bg-[#EFEFEF] rounded-lg shadow-md shadow-[#00000099]',
                  children: [
                    _jsxs('div', {
                      className:
                        'flex justify-between px-2 md:mt-2 mb-2 md:mb-3 pt-1',
                      children: [
                        _jsx('p', { children: expense.name }),
                        _jsx('button', {
                          onClick: () => {
                          ...
                          children: _jsx('svg', {
                            className:
                              'md:w-[25px] md:h-[25px] w-4 h-4 mt-1 text-[#01898B]',
                            viewBox: '0 0 16 16',
                            children: _jsx('path', {
                              fill: '000',
                    ...
                    _jsxs('div', {
                      ...
                      children: [
                        _jsxs('p', {
                          children: ['Date Due: ', expense.dueDate],
                        }),
                        _jsxs('p', { children: ['$', expense.amount] }),
                      ],
                    }),
                  ],
                },
          ...
          _jsxs('div', {
            className:
              'h-5 md:h-6 flex justify-between items-center px-2 font-bold',
            children: [
              _jsx('p', {
